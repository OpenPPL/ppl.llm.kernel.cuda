...
#  CUDNN_LIBRARY_DIR: Directory where CUDNN library is searched for
...
list(APPEND CUDNN_ROOT ${CUDA_TOOLKIT_ROOT_DIR})
...
set(CUDNN_LIBRARY_DIR $ENV{CUDNN_LIBRARY_DIR} CACHE PATH "Path to the cudnn library file (e.g., libcudnn.so)")
if (CUDNN_LIBRARY_DIR MATCHES ".*cudnn_static.a" AND NOT CUDNN_STATIC)
  message(WARNING "CUDNN_LIBRARY_DIR points to a static library (${CUDNN_LIBRARY_DIR}) but CUDNN_STATIC is OFF.")
endif()
...
find_package_handle_standard_args(CUDNN DEFAULT_MSG CUDNN_LIBRARY CUDNN_INCLUDE_PATH)
...
mark_as_advanced(CUDNN_ROOT CUDNN_INCLUDE_DIR CUDNN_LIBRARY_DIR CUDNN_VERSION)
