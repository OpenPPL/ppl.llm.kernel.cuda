...
template<typename Kernel_traits, bool Is_dropout, bool Is_causal, bool Is_local, bool Has_alibi, bool Has_bias, bool Is_even_MN, bool Is_even_K, bool Return_softmax>
            ...
            BOOL_SWITCH((params.window_size_left >= 0 || params.window_size_right >= 0) && !Is_causal, Is_local, [&] {
                ...
                constexpr bool ReturnSoftmaxConst = false;
                {
                    BOOL_SWITCH(params.alibi_slopes_ptr != nullptr, Has_alibi, [&] {
                        BOOL_SWITCH(params.bias_ptr != nullptr, Has_bias, [&] {
